...
def deleteAgent():
    ...
    ui.label('Eliminar Agente').classes('text-4xl font-bold text-center mt-12 mb-8')

    with ui.card().classes('w-3/4 max-w-3xl mx-auto p-10 shadow-2xl rounded-2xl bg-white'):
        dpiInput = ui.input('Ingrese el DPI del agente a eliminar').classes('w-full text-lg mb-4')
